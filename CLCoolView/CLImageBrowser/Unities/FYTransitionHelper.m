...
- (instancetype)initWithOriginalImageView:(UIImageView *)originalImageView frame:(CGRect)frame finalImageView:(UIImageView *)finalImageView {
    ...
    if (self) {
        ...
        finalData.imageView.contentMode = UIViewContentModeScaleAspectFit;
